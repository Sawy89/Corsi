# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 15:56:50 2019
...
'''
--> Si può utilizzare sys.settrace per testare ad ogni esecuzione le variabili in gioco!!!
'''
...
class Range:
    ...
    def track(self, value):
        # YOUR CODE
        self.min = value if self.min==None or value < self.min else self.min
        self.max = value if self.max==None or value > self.max else self.max
